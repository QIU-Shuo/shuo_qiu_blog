...
abstract: "A coding benchmark can run out of signal long before anyone scores 100% on it. Four audits later, every improved version of SWE-bench still had broken tasks."
metaDescription: "Four audits failed to produce a clean SWE-bench, and Terminal-Bench revised 31% of its tasks. Why coding benchmark corrections always arrive after the scores."
draft: false
relatedPosts:
